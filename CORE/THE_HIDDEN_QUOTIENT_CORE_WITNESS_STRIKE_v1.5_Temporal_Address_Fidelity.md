...
### Multiplication representation over arbitrary measures, with two declared readings and six typed companion bridges

**Status:** unified master edition — family-built  
**Version:** 1.5 — v1.0 mathematical core preserved; retained-context, Open-Seam, constraint-demotion, constraint-status, and temporal-address companions added; Seat 2, Seat 5, and governing OMNIBUS v5.57 clauses retained  
...
Six bridge cards follow the mathematical core. Bridge I separates visibility from completion. Bridge II states the retained-context upgrade in typed form. Bridge III extends local transport into a directed atlas of typed seams, paths, alternate routes, and loop returns. Bridge IV supplies an event-level audit for constraint demotion across independently located empirical families. Bridge V completes the post-event binding-by-route state space and makes macrostate labels explicit projections. Bridge VI adds typed constraint, route, and holder identities plus Temporal Address Fidelity and correction dynamics. Bridges II–VI are companions to the theorem layer, not additional theorems, new seats, or backward alterations of Part I.
