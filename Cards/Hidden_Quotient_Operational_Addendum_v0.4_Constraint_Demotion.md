...
**Version:** v0.4 — constraint-demotion audit extension  
**Date:** 2026-08-31  
**License:** CC0 — Public Domain — No rights reserved  
**Continuity:** preserves v0.3 and its v0.2 predecessor, and extends *The Hidden Quotient Behind the Multiplication Representation* and *The Hidden Quotient in Lattice Charts, Topological Return, and Prime-Gap Projection* v0.1
...
## 12. Recent application crosswalk
