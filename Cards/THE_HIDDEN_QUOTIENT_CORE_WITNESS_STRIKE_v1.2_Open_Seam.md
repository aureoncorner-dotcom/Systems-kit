...
### Multiplication representation over arbitrary measures, with two declared readings and two typed companion bridges

**Status:** unified master edition — family-built  
**Version:** 1.2 — v1.0 mathematical core preserved; retained-context and Open-Seam companions added; Seat 2, Seat 5, and governing OMNIBUS v5.57 clauses retained  
...
Three bridge cards follow the mathematical core. Bridge I separates visibility from completion. Bridge II states the retained-context upgrade in typed form. Bridge III extends local transport into a directed atlas of typed seams, paths, alternate routes, and loop returns. Bridges II–III are companions to the theorem layer, not additional theorems, new seats, or backward alterations of Part I.
